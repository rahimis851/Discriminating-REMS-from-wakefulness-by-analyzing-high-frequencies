...
DataSource=2;                            % 1 means Motor Cortex, 2 means Sensory Cortex, 3 means Visual Cortex
...
NonREMvsREM=0;                                           % NonREM versus REM
...
AllFrequecyRanges=1;                                      % 1 means Feature Extracting using all Frequency Ranges
SpecifiedFreqRange=0;                                     % Between 1 to 9 (See aFreq or bFreq) - If AllFrequecyRanges=0
